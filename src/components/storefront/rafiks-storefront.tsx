  ...
  return (
    <div className={`rr-site ${loaded ? "rr-ready" : ""}`}>
      ...
      <main id="main">
        ...
        <section className="rr-story"><Reveal><p className="rr-kicker">Our story / Our craft</p></Reveal><Reveal delay={120}><h2>We truly care about your rug needs...</h2></Reveal></section>
